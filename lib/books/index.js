...
exports.checkAccounts = function (accounts) {
...
// Gets accounts, checks debits/credits match
exports.getCheck = function(dir) {
    return this.getAccounts(dir).then(this.checkAccounts);
};
